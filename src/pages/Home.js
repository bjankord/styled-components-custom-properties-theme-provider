...
// Using fallback provider and themeProperty to highlight way to support browsers that don't support CSS custom properties
import { CustomPropertiesFallbackThemeProvider, themeProperty } from "../lib";
...
const Button = styled.button`
  ...
  border-color: ${props => themeProperty("button-border-color", "palevioletred", props)};
`;
...
function Home() {
  return (
    <div>
      ...
      <CustomPropertiesFallbackThemeProvider theme={theme}>
